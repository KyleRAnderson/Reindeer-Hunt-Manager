...
class RostersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create roster" do
    assert_difference('Roster.count') do
      post rosters_url, params: { roster: { extra_attributes: @roster.extra_attributes, name: @roster.name } }
    end
  ...
  test "should update roster" do
    patch roster_url(@roster), params: { roster: { extra_attributes: @roster.extra_attributes, name: @roster.name } }
